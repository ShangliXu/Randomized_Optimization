...
prob_domains_name_list = ['FlipFlop']#['Nqueens', 'MaxKColor', 'TSP']
problem_size_map = {'FlipFlop':[10, 20, 50]}#{'Nqueens':[8, 20], 'MaxKColor':[8, 20], 'TSP':[10, 20, 100]}#[8, 20, 50]
fitness_list_list = []
...
# fitness_list
# Out[2]: [[9.0, 9.0, 9.0, 8.0], [19.0, 19.0, 19.0, 15.0], [38.0, 49.0, 48.0, 40.0]]
